...
(function () {
  ...
  function update() {
    var cat        = document.getElementById('ms-req-cat');
    var titleLabel = document.getElementById('ms-req-title-lbl');
    var titleInput = document.getElementById('ms-req-title');
    var noteInput  = document.getElementById('ms-req-note');
  ...
  function init() {
    ...
    var btn = document.querySelector('button.ms-req-submit');
    if (!btn) return;
    ...
    btn.addEventListener('click', function (e) {
      ...
      var titleInput = document.getElementById('ms-req-title');
      var noteInput  = document.getElementById('ms-req-note');
      var linkEl     = document.getElementById('ms-req-link');
      ...
      Promise.all([
        ...
        .then(function () {
          ...
          var form = document.getElementById('ms-req-form');
